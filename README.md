...
This course has two parts, slides and excercises. The slides describe the excercices in detail. Each excercise has a starting branch and solution branch. Example `lesson-1` and `lesson-1-solution`.
